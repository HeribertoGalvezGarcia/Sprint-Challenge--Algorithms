...
class SortingRobot(Generic[T]):
    ...
    def __init__(self, list_: List[T]) -> None:
        """
        SortingRobot takes a list and sorts it.
        """
        self._list = list_      # The list the robot is tasked with sorting
    ...
    def compare_item(self) -> Optional[int]:
        """
...
def main() -> None:
    ...
    list_ = [15, 41, 58, 49, 26, 4, 28, 8, 61, 60, 65, 21, 78, 14, 35, 90, 54, 5, 0, 87, 82, 96, 43, 92, 62, 97, 69, 94,
